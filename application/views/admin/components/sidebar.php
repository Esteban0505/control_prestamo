<ul class="navbar-nav sidebar sidebar-dark accordion" 
    style="background: linear-gradient(180deg, #0d0d0d 0%, #024d53ff 40%, #076268ff 70%, #000000ff 100%);" 
    id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
    ...
    <div class="sidebar-brand-text mx-3">Control Prestamo </div>
  </a>
  ...
  <li class="nav-item">
    ...
    <div id="collapseReportes" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar" style="">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" >Resumen General</a>
        <a class="collapse-item" ?>">Entre Fechas</a>
        <a class="collapse-item" ?>">General x cliente</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item">
    ...
    <div id="collapseConfiguracion" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar" style="">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="Anuel"> Editar datos</a>
        <a class="collapse-item" href="Falta"> Cambiar Contraseña</a>
      </div>
    </div>
  </li>
