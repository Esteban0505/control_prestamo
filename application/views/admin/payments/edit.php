          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <select name="tipo_pago" id="tipo_pago" class="form-control" required>
                      ...
                      <option value="total_condonacion">Pago Total Anticipado (Con Condonación)</option>
                ...
                <div class="col-md-2" id="custom_payment_options" style="display: none;">
                  <div class="form-group">
                    <label class="small mb-1 font-weight-bold">Tipo de Pago</label>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="custom_payment_type" id="pago_parcial" value="partial" checked>
                      <label class="form-check-label small" for="pago_parcial">
                        Pago parcial
                      </label>
                      <small class="text-muted">Saldo distribuido en cuotas futuras</small>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="custom_payment_type" id="pago_no_completo" value="incomplete">
                      <label class="form-check-label small" for="pago_no_completo">
                        Pago no completo
                      </label>
                      <small class="text-muted">Saldo pendiente en cuota actual</small>
                    </div>
                    <small class="form-text text-muted">Selecciona el tipo de pago personalizado</small>
                  </div>
                </div>

                <!-- FALLBACK HTML: Mostrar campo personalizado por defecto si JavaScript está deshabilitado -->
                <noscript>
                  <div class="col-md-2">
                    <div class="form-group">
                      <label class="small mb-1 font-weight-bold" for="custom_amount_fallback">Monto Personalizado (Sin JS)</label>
                      <input type="number" name="custom_amount" id="custom_amount_fallback" class="form-control" placeholder="0.00" step="0.01" min="0">
                      <small class="form-text text-muted">Campo alternativo cuando JavaScript está deshabilitado</small>
                    </div>
                  </div>
                </noscript>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea name="payment_description" id="payment_description" class="form-control" rows="2" placeholder="Pago personalizado - Monto aplicado secuencialmente a cuotas seleccionadas"></textarea>
                    <small class="form-text text-muted">Opcional - Documenta el pago (valor por defecto aplicado automáticamente)</small>
                  </div>
                </div>
              </div>
