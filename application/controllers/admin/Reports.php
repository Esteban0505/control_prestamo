...
class Reports extends CI_Controller {
  ...
  public function index()
  {
    ...
    if ($this->db->table_exists('collector_commissions')) {
      $q = $this->db->query("SELECT u.id, u.first_name, u.last_name, u.role, SUM(c.commission) AS total_commission, COUNT(c.id) AS total_cobranzas FROM collector_commissions c JOIN users u ON u.id = c.user_id GROUP BY u.id, u.first_name, u.last_name, u.role");
      $data['collector_commissions'] = $q->result();
    } else {
